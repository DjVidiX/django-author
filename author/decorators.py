...
def with_author(cls):
    ...
    created_by = models.ForeignKey(user_model, verbose_name=_('author'), related_name='%(class)s_related_author', null=True, blank=True)
    updated_by = models.ForeignKey(user_model, verbose_name=_('last updated by'), related_name='%(class)s_related_modifier', null=True, blank=True)
